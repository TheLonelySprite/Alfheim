 ...
 */
public class WorldGenDreamwoodForest extends WorldGenAbstractTree {
    private boolean field_150531_a;
    private static final String __OBFID = "CL_00000401";

    public WorldGenDreamwoodForest(boolean p_i45449_1_, boolean p_i45449_2_)
    {
        super(p_i45449_1_);
            ...
            else
            {
                ...
                if (isSoil && p_76484_4_ < 256 - l - 1)
                {
                    ...
                    for (k2 = 0; k2 < l; ++k2)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + k2, p_76484_5_, ModBlocks.dreamwood, 0);
                        }
                    }
