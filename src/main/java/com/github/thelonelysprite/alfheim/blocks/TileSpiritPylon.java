 ...
 */
public class TileSpiritPylon extends TileEntity {
    ...
    public void updateEntity() {
        ...
        if(activated && worldObj.isRemote) {
            ...
            if(meta == 1) {
                ...
                if(block == vazkii.botania.common.block.ModBlocks.flower || block == vazkii.botania.common.block.ModBlocks.shinyFlower) {
    ...
    private Block getBlockForMeta() {
        return getBlockMetadata() == 0 ? vazkii.botania.common.block.ModBlocks.enchanter : vazkii.botania.common.block.ModBlocks.alfPortal;
    }
