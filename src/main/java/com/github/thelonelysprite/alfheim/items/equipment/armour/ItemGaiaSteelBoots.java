 ...
 */
public class ItemGaiaSteelBoots extends ItemGaiaSteelArmour {
    public ItemGaiaSteelBoots() {
        super(3, "gaiaSteelBoots");
    }
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack stack) {
        ...
        if (player.getCurrentArmor(0) != null && player.getCurrentArmor(0).getItem() == this) {
            int level = -1;
            for (int i = 0; i < 4; i++) {
